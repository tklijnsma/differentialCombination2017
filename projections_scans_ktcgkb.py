...
class CombineConfigKTCGKB(differentials.combine.combine.CombineConfig):
    ...
    def range_couplingdependentBRs(self, args):
        if args.hzz:
            ...
            self.range_combWithHbb_couplingdependentBRs()

    def range_hzz_couplingdependentBRs(self):
        self.nPoints = 40*40
        self.nPointsPerJob = 200
        self.set_parameter_range('ct', -0.8, 3.2)
        self.set_parameter_range('cg', -0.15, 0.16)

    def range_hgg_couplingdependentBRs(self):
        self.nPoints = 40*40
        self.nPointsPerJob = 10
        self.set_parameter_range('ct', 0.3, 3.1)
        self.set_parameter_range('cg', -0.05, 0.08)

    def range_combWithHbb_couplingdependentBRs(self):
        self.nPoints = 40*40
        self.nPointsPerJob = 10
        self.set_parameter_range('ct', 0.6, 1.4)
        self.set_parameter_range('cg', -0.02, 0.04)
    ...
    def range_floatingBRs(self, args):
        if args.hzz:
            ...
            self.range_combWithHbb_floatingBRs()
    ...
    def range_combWithHbb_floatingBRs(self):
        self.range_hgg_floatingBRs()
...
workspaces.floatingBRs.combination          = 'out/workspaces_Jul10/projection_ktcgkb_combWithHbb_Jul10_couplingModel_reweighted_constrainedbbZZ_floatingBRs.root'
